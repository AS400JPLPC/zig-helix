...
envZIG="2"
PROJECT="ZMMAP"
LIBPROJECT="/home/soleil/Zmmap/"
LIBRARY="/home/soleil/Zmmap/library/"
choix=""
...
do
	...
	f_dsplyPos 11  20 $faGras$fcRouge'21.'; f_dsplyPos 11  24 $faGras$fcGreen 'Mcursed'
	f_dsplyPos 12  20 $faGras$fcRouge'22.'; f_dsplyPos 12  24 $faGras$fcGreen 'Pcall'
...
#Gencurs
		10)
			/home/soleil/.Terminal/dispatch.sh $envZIG $LIBPROJECT   "Pmaitre"
		;;

#Example
		11)
			/home/soleil/.Terminal/dispatch.sh $envZIG $LIBPROJECT   "Pecho"
		;;


#Example
		20)
			/home/soleil/.Terminal/dispatch.sh $envZIG $LIBPROJECT   "Ecursed"
		;;

#Example
		21)
			/home/soleil/.Terminal/dispatch.sh $envZIG $LIBPROJECT   "Mcursed"
		;;
		
#Example
		22)
			/home/soleil/.Terminal/dispatch.sh $envZIG $LIBPROJECT   "Pcall"
		;;
